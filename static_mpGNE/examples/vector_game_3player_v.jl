# static_mpgne_fast.jl — Compact mpGNE example (default)
# Fast pipeline: numeric params defined upfront, no display overhead
# Usage: run from static_mpGNE/examples/ directory
